                ...
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    ...
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '#' }" class="btn new-tab-btn"
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>gym</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '#' }" class="btn new-tab-btn" target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Electronic</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '#-1' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
